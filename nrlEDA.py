...
'Deidentified Club Home Name', 'DistanceMs', 'DurationSecs', 'ElapsedMillisecs', 'ElapsedMins', 'ElapsedSecs', 'EventCode', 
# 'EventName', 
'GameMins', 'GameSecs', 'Half', 'Home Score', 'InPossessionClub Id', 'InPossessionPlayerId', 
# 'MatchId', 
